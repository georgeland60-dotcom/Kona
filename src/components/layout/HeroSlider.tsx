...
export default function HeroSlider({ banners }: { banners: Banner[] }) {
  ...
  return (
    <section className="relative overflow-hidden bg-soft">
      {/* Grid apilado: todos los slides ocupan la misma celda (grid-area 1/1),
          así el contenedor crece con el slide más alto y funciona en móvil
          y escritorio sin recortes. */}
      <div className="grid">
        {banners.map((b, idx) => (
          <div
            key={b.id}
          ...
          >
            <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 items-center gap-8 min-h-[26rem] md:min-h-[32rem] pb-14 md:pb-0">
              {/* Texto */}
