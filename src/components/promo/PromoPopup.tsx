...
const COLORES = [
  { bar: "bg-v3-primary", chip: "bg-v3-primary" },
  { bar: "bg-v3-teal", chip: "bg-v3-teal" },
  { bar: "bg-v3-coral", chip: "bg-v3-coral" },
  { bar: "bg-v3-lilac", chip: "bg-v3-lilac" },
  { bar: "bg-v3-amber", chip: "bg-v3-amber" },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl bg-white shadow-2xl animate-v3-pop-in">
        {/* Cabecera de color */}
        <div className="relative bg-gradient-to-r from-v3-primary via-v3-lilac to-v3-coral px-6 py-7 text-center text-white">
        ...
        <ul className="divide-y divide-line">
          {promos.map((promo, idx) => {
            ...
            return (
              <li key={promo.id} className="flex items-stretch gap-4 px-5 py-4">
                <span
                  aria-hidden="true"
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-v3-ink text-lg leading-snug">
                    {promo.title}
                  </p>
                  <p className="text-v3-ink-soft text-base leading-snug mt-0.5">
                    {promo.detail}
                  </p>
                </div>
                <Link
        ...
        <div className="px-5 pb-5 pt-1">
          <button
            type="button"
            onClick={cerrar}
            className="w-full text-center text-v3-ink-soft text-base py-2 hover:text-v3-primary transition"
          >
